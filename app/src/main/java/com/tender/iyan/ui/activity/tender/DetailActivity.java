...
public class DetailActivity extends AppCompatActivity implements TenderService.GetPenawaranView, DetailAdapter.OnOpenMapClickListener, DetailAdapter.OnDealClickListener, TenderService.SaveDealView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CountDownTimer cdt = new CountDownTimer(total_millis, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                textView.setText(days + " Hari | " + hours + " Jam | " + minutes + " Menit | " + seconds + " Detik"); //You can compute the millisUntilFinished on hours/minutes/seconds
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.option_most_expensive) {
            ...
            TenderService.getInstance().filterPenawaranByTender(this, tender, TenderService.MOST_EXPENSIVE);
        }
    ...
    public void onLoadDataSuccess(List<Penawaran> penawaranList) {
        Log.d(TAG, "onLoadDataSuccess: " +  penawaranList.toString());
    ...
    @Override public void onOpenMapClick(int position) {
        if (penawaranList != null && !penawaranList.isEmpty()){
            ...
            String uri = "http://maps.google.com/maps?q=loc:" + penawaran.getLat() + "," + penawaran.getLng() + " (" + penawaran.getNama() + ")";
    ...
    @Override public void onDealClick(int position) {
        if (penawaranList != null && !penawaranList.isEmpty()){
            TenderService.getInstance().uploadDeal(this, tender.getId(), penawaranList.get(position).getId());
        }
    }
